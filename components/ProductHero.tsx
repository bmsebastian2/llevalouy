...
export default function ProductHero({ product }: { product: Product }) {
  ...
  return (
    <section className="mx-auto max-w-5xl pt-6 md:grid md:grid-cols-2 md:gap-10 md:px-4 md:py-10">
      {/* pt en celular: aire entre la costa del header y la foto */}
      ...
      <div className="px-4 pt-5 md:px-0 md:pt-4">
        ...
        <p className="mt-3 text-ink/75">Efectivo o transferencia al recibir. No pagás nada ahora.</p>
